  ...
  <div>
    ...
    >  
     <el-row>
            ...
            <el-form-item class="select" label="部门信息" prop="bumenId">
                <el-select v-model="ruleForm.bumenId" filterable placeholder="请选择部门信息" @change="bumenChange">
                    <el-option
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'" label='部门编号' prop="bumenUuidNumber">
                 <el-input v-model="bumenForm.bumenUuidNumber" disabled></el-input>
             </el-form-item>
         </el-col>
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'" label='部门名称' prop="bumenName">
                 <el-input v-model="bumenForm.bumenName" disabled></el-input>
             </el-form-item>
         </el-col>
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'" label='部门位置' prop="bumenAddress">
                 <el-input v-model="bumenForm.bumenAddress" disabled></el-input>
             </el-form-item>
         </el-col>
         <el-col :span="12">
...
// 注册表 用户
    // 注册的级联表 用户
        if(table == 'yonghu'){
            this.bumenChange(this.ruleForm.bumenId);
        }
      } else {
...
// 注册表的级联表
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.bumenId)&& 'yonghu'==this.flag){
