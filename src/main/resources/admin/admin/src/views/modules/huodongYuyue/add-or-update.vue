    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="请假理由" prop="huodongYuyueText">
                        <el-input type="textarea"  :readonly="ro.huodongYuyueText" v-model="ruleForm.huodongYuyueText" placeholder="请假理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.huodongYuyueText" label="请假理由" prop="huodongYuyueText">
            ...
            <el-col :span="12" v-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.huodongYuyueTime"  class="input" label="预约时间" prop="huodongYuyueTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.huodongYuyueTime"
                                type="datetime"
                                placeholder="预约时间"
                                :disabled="ro.huodongYuyueTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.huodongYuyueTime" label="预约时间" prop="huodongYuyueTime">
                            <span v-html="ruleForm.huodongYuyueTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
