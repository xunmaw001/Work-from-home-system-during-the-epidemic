    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="考勤结果" prop="kaoqinTypes">
                        <el-select v-model="ruleForm.kaoqinTypes" :disabled="ro.kaoqinTypes" placeholder="请选择考勤结果">
                            <el-option
                                v-for="(item,index) in kaoqinTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="考勤结果" prop="kaoqinValue">
                        <el-input v-model="ruleForm.kaoqinValue"
                            placeholder="考勤结果" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.kaoqinContent"  label="考勤详情" prop="kaoqinContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.kaoqinContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kaoqinContent" label="考勤详情" prop="kaoqinContent">
                            <span v-html="ruleForm.kaoqinContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.kaoqinTime"  class="input" label="考勤日期" prop="kaoqinTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.kaoqinTime"
                                type="date"
                                placeholder="考勤日期"
                                :disabled="ro.kaoqinTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kaoqinTime" label="考勤日期" prop="kaoqinTime">
                            <span v-html="ruleForm.kaoqinTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   kaoqinTypes: [
                              { required: true, message: '考勤结果不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=kaoqin_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.kaoqinTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.kaoqinContent = _this.ruleForm.kaoqinContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.kaoqinContent = this.ruleForm.kaoqinContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`kaoqin/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.kaoqinCrossAddOrUpdateFlag = false;
                                        this.parent.search();
