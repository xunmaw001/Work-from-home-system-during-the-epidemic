<template>
    <div class="addEdit-block">
        <el-form
                ...
                >
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='bumen'">
                    <el-form-item class="select" v-if="type!='info'"  label="部门信息" prop="bumenId">
                        <el-select v-model="ruleForm.bumenId" :disabled="ro.bumenId" filterable placeholder="请选择部门信息" @change="bumenChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='bumen' ">
                    <el-form-item class="input" v-if="type!='info'"  label="部门编号" prop="bumenUuidNumber">
                        <el-input v-model="bumenForm.bumenUuidNumber"
                                  placeholder="部门编号" clearable readonly></el-input>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='bumen' ">
                    <el-form-item class="input" v-if="type!='info'"  label="部门名称" prop="bumenName">
                        <el-input v-model="bumenForm.bumenName"
                                  placeholder="部门名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='bumen' ">
                    <el-form-item class="input" v-if="type!='info'"  label="部门位置" prop="bumenAddress">
                        <el-input v-model="bumenForm.bumenAddress"
                                  placeholder="部门位置" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
...
<script>
    ...
    export default {
        ...
        created() {
         ...
         this.$http({
             url: `bumen/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.bumenOptions = data.data.list;
            }
         });
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.bumenChange(data.data.bumenId)
                    } else {
