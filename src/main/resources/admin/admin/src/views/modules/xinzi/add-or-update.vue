    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="基本工资" prop="jibenJine">
                       <el-input v-model="ruleForm.jibenJine"
                                 placeholder="基本工资" clearable  :readonly="ro.jibenJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="基本工资" prop="jibenJine">
                           <el-input v-model="ruleForm.jibenJine"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="奖金" prop="jiangjinJine">
                       <el-input v-model="ruleForm.jiangjinJine"
                                 placeholder="奖金" clearable  :readonly="ro.jiangjinJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="奖金" prop="jiangjinJine">
                           <el-input v-model="ruleForm.jiangjinJine"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="补贴" prop="butieJine">
                       <el-input v-model="ruleForm.butieJine"
                                 placeholder="补贴" clearable  :readonly="ro.butieJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="补贴" prop="butieJine">
                           <el-input v-model="ruleForm.butieJine"
                                     placeholder="补贴" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
