    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">疫情居家办公系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                       ...
                       <!--<el-form-item class="select" label="部门">
                            <el-select style="width: 399px;height: 40px;" v-model="ruleForm.bumenId" placeholder="请选择部门">
                                <el-option
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            //// 用户 的 部门
                            // if((!this.ruleForm.bumenId)&& 'yonghu'==this.tableName){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/yiqngjujiabangongxitong/img/back-img-bg.jpg);
