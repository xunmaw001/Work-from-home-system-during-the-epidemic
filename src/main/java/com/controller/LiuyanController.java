...
//        else if("用户".equals(role))
//            liuyan.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        if("".equals(liuyan.getLiuyanText()) || "null".equals(liuyan.getLiuyanText())){
                liuyan.setLiuyanText(null);
        }
        if("".equals(liuyan.getReplyText()) || "null".equals(liuyan.getReplyText())){
                liuyan.setReplyText(null);
        }
