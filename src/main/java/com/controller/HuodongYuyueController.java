...
//        else if("用户".equals(role))
//            huodongYuyue.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        if("".equals(huodongYuyue.getHuodongYuyueText()) || "null".equals(huodongYuyue.getHuodongYuyueText())){
                huodongYuyue.setHuodongYuyueText(null);
        }
        if("".equals(huodongYuyue.getHuodongYuyueYesnoText()) || "null".equals(huodongYuyue.getHuodongYuyueYesnoText())){
                huodongYuyue.setHuodongYuyueYesnoText(null);
        }
...
//                            huodongYuyueEntity.setHuodongYuyueText(data.get(0));                    //请假理由 要改的
...
//                            huodongYuyueEntity.setHuodongYuyueTime(sdf.parse(data.get(0)));          //预约时间 要改的
