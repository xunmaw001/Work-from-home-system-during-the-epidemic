                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            ZiliaoEntity ziliaoEntity = new ZiliaoEntity();
//                            ziliaoEntity.setZiliaoName(data.get(0));                    //公司资料名称 要改的
//                            ziliaoEntity.setZiliaoUuidNumber(data.get(0));                    //公司资料编号 要改的
//                            ziliaoEntity.setZiliaoPhoto("");//详情和图片
//                            ziliaoEntity.setZiliaoTypes(Integer.valueOf(data.get(0)));   //公司资料类型 要改的
//                            ziliaoEntity.setZiliaoFile(data.get(0));                    //公司资料下载 要改的
...
//                            ziliaoEntity.setCreateTime(date);//时间
                        ...
                        if(ziliaoEntities_ziliaoUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [公司资料编号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
