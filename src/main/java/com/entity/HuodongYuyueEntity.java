...
public class HuodongYuyueEntity<T> implements Serializable {
     ...
     * 请假理由
     */
    @ColumnInfo(comment="请假理由",type="longtext")
    ...
    @TableField(value = "huodong_yuyue_time")

    private Date huodongYuyueTime;
	 ...
	 * 获取：预约时间
	 */
    public Date getHuodongYuyueTime() {
        return huodongYuyueTime;
    }
    /**
	 * 设置：预约时间
	 */

    public void setHuodongYuyueTime(Date huodongYuyueTime) {
        this.huodongYuyueTime = huodongYuyueTime;
    }
    /**
	 * 获取：创建时间  listShow
	 */
    ...
    public String toString() {
        return "HuodongYuyue{" +
            ...
            ", huodongYuyueTime=" + DateUtil.convertString(huodongYuyueTime,"yyyy-MM-dd") +
