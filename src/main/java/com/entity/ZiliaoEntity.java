...
public class ZiliaoEntity<T> implements Serializable {
     ...
     * 公司资料名称
     */
    @ColumnInfo(comment="公司资料名称",type="varchar(200)")
     ...
     * 公司资料编号
     */
    @ColumnInfo(comment="公司资料编号",type="varchar(200)")
     ...
     * 公司资料照片
     */
    @ColumnInfo(comment="公司资料照片",type="varchar(200)")
     ...
     * 公司资料类型
     */
    @ColumnInfo(comment="公司资料类型",type="int(11)")
     ...
     * 公司资料下载
     */
    @ColumnInfo(comment="公司资料下载",type="varchar(200)")
     ...
     * 公司资料介绍
     */
    @ColumnInfo(comment="公司资料介绍",type="longtext")
